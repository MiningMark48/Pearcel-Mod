...
public class InventoryEnlargedPearcelBackpack implements IInventory{

    private String name = "Enlarged Pearcel Backpack";
    ...
    public InventoryEnlargedPearcelBackpack(ItemStack stack){
