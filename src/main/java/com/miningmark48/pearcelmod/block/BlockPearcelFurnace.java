...
public class BlockPearcelFurnace extends BlockContainer {
    ...
    protected BlockPearcelFurnace(boolean isBurning)
    {
        super(Material.ROCK);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityPearcelFurnace)
            {
                //((TileEntityPearcelFurnace)tileentity).setCustomInventoryName(stack.getDisplayName()); //TODO
            }
        }
    }
