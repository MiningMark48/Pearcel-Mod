...
public class BlockDragonInfusedPearcel extends BlockPearcelMod{

    public IIcon[] icons = new IIcon[6];

    public BlockDragonInfusedPearcel(){
        super();
    }
        ...
        for (int l = p_149734_2_ - 2; l <= p_149734_2_ + 2; ++l)
        {
            for (int i1 = p_149734_4_ - 2; i1 <= p_149734_4_ + 2; ++i1)
            {
                ...
                if (p_149734_5_.nextInt(16) == 0)
                {
                    ...
                    {
                        if (p_149734_1_.getBlock(l, j1-1, i1) == ModBlocks.enderInfusedPearcel)
                        {
