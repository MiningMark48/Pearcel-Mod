...
public class BlockCompressedSugarCanePlant extends Block implements IPlantable
{
    private static final String __OBFID = "CL_00000300";

    public BlockCompressedSugarCanePlant()
    {
    ...
    {
        return ModItems.compressedSugarCaneItem;
    }
