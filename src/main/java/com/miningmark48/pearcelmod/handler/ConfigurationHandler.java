...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration(){
        ...
        rfStorage_magnet = configuration.getInt(ModTranslate.toLocal("config.rfStorage_magnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 750000, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
        rfTransferPerTick_magnet = configuration.getInt(ModTranslate.toLocal("config.rfTransferPerTick_magnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 10000, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
        rfPerTick_magnet = configuration.getInt(ModTranslate.toLocal("config.rfPerTick_magnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 10, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
        ...
        rfStorage_livingMagnet = configuration.getInt(ModTranslate.toLocal("config.rfStorage_livingMagnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 1000000, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
        rfTransferPerTick_livingMagnet = configuration.getInt(ModTranslate.toLocal("config.rfTransferPerTick_livingMagnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 10000, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
        rfPerTick_livingMagnet = configuration.getInt(ModTranslate.toLocal("config.rfPerTick_livingMagnet.title"), ModTranslate.toLocal("config.category.powerUsage.title"), 75, 1, Integer.MAX_VALUE, ModTranslate.toLocal("config.rfPerTick.desc"));
