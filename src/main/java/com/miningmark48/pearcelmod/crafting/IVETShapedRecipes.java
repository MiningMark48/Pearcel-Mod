...
public class IVETShapedRecipes implements IRecipe
{
    ...
    public IVETShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public IVETShapedRecipes func_92100_c()
    {
