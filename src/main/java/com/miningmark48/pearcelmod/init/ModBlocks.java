...
public class ModBlocks {
    ...
    public static void init(){
        ...
        pearcel_spike = new BlockPearcelSpike().setUnlocalizedName("pearcel_spike").setRegistryName("pearcel_spike").setCreativeTab(CreativeTabPearcelMod.PearcelMod_TAB);
