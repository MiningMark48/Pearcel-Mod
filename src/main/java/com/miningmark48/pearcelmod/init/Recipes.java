...
public class Recipes {
    ...
    public static void init(){
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.neutral_pearcel_matter, 2), "xyx", "yzy", "xyx", 'x', new ItemStack(Items.DIAMOND), 'y', new ItemStack(ModItems.pearcel_ingot), 'z', new ItemStack(ModItems.tier_2_crafting_component));
        GameRegistry.addRecipe(new ItemStack(ModItems.neutral_pearcel_matter, 4), "xyx", "yzy", "xyx", 'x', new ItemStack(Items.DIAMOND), 'y', new ItemStack(ModItems.pearcel_ingot), 'z', new ItemStack(ModItems.tier_3_crafting_component));
        GameRegistry.addRecipe(new ItemStack(ModItems.neutral_pearcel_matter, 6), "xyx", "yzy", "xyx", 'x', new ItemStack(Items.DIAMOND), 'y', new ItemStack(ModItems.pearcel_ingot), 'z', new ItemStack(ModItems.tier_4_crafting_component));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.stimulation_pearcel), "xyx", "yzy", "xyx", 'x', new ItemStack(ModItems.pearcel_item), 'y', new ItemStack(ModItems.tier_4_crafting_component), 'z', new ItemStack(Items.CLOCK));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.rif_pearcel_chestplate), "aza", "zyz", "xzx", 'x', new ItemStack(ModItems.tier_4_crafting_component), 'y', new ItemStack(ModItems.pearcel_chestplate), 'z', new ItemStack(ModItems.armor_plating), 'a', new ItemStack(ModItems.pearcel_matter));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.pearcel_magnet_advanced), "aya", "yzy", "xyx", 'x', new ItemStack(ModItems.tier_3_crafting_component), 'y', new ItemStack(ModItems.pearcel_item), 'z', new ItemStack(ModItems.pearcel_magnet), 'a', new ItemStack(ModItems.ender_pearcel));
        ...
        ItemStack charmed_pearcel_hearty = new ItemStack(ModItems.charmed_pearcel);
        ...
        if (!charmed_pearcel_hearty.hasTagCompound()) charmed_pearcel_hearty.setTagCompound(new NBTTagCompound());
        ...
        charmed_pearcel_hearty.getTagCompound().setString("type", "hearty");
        ...
        GameRegistry.addShapelessRecipe(charmed_pearcel_hearty, new ItemStack(ModItems.charmed_pearcel), new ItemStack(ModItems.pearcel_matter), new ItemStack(Items.SPECKLED_MELON));
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_spike, 3), "xxx", "yay", "zbz", 'x', new ItemStack(ModItems.pearcel_stick), 'y', new ItemStack(ModBlocks.pearcel_block), 'z', new ItemStack(ModBlocks.pearcel_planks), 'a', new ItemStack(ModItems.tier_2_crafting_component), 'b', new ItemStack(ModBlocks.pearcel_ingot_block));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_spike_ender, 6), "xxx", "yay", "zbz", 'x', new ItemStack(ModBlocks.pearcel_spike), 'y', new ItemStack(ModBlocks.pearcel_block), 'z', new ItemStack(ModBlocks.ender_pearcel_block), 'a', new ItemStack(ModItems.tier_3_crafting_component), 'b', new ItemStack(ModBlocks.pearcel_ingot_block));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_spike_guardian, 6), "xxx", "yay", "zbz", 'x', new ItemStack(ModBlocks.pearcel_spike_ender), 'y', new ItemStack(ModBlocks.pearcel_block), 'z', new ItemStack(ModBlocks.tainted_pearcel), 'a', new ItemStack(ModItems.tier_4_crafting_component), 'b', new ItemStack(ModBlocks.pearcel_ingot_block));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_furnace), "xxx", "xyx", "xzx", 'x', new ItemStack(ModBlocks.pearcel_cobblestone), 'y', new ItemStack(ModItems.tier_1_crafting_component), 'z', new ItemStack(Blocks.FURNACE));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_generator), "xxx", "xyx", "xzx", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(ModItems.tier_2_crafting_component), 'z', new ItemStack(ModBlocks.pearcel_furnace));

        GameRegistry.addRecipe(new ItemStack(Blocks.BEACON), "xxx", "xyx", "zzz", 'x', new ItemStack(Blocks.GLASS), 'y', new ItemStack(ModItems.pearcel_star), 'z', new ItemStack(Blocks.OBSIDIAN));

        //Pearcel Matter Recipes
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcel_matter, 1), new ItemStack(ModItems.neutral_pearcel_matter), new ItemStack(ModItems.tier_1_crafting_component));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcel_matter, 2), new ItemStack(ModItems.neutral_pearcel_matter), new ItemStack(ModItems.tier_2_crafting_component));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcel_matter, 4), new ItemStack(ModItems.neutral_pearcel_matter), new ItemStack(ModItems.tier_3_crafting_component));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcel_matter, 6), new ItemStack(ModItems.neutral_pearcel_matter), new ItemStack(ModItems.tier_4_crafting_component));
        ...
        GameRegistry.addRecipe(new ItemStack(Items.NETHER_STAR), "xxx", "xyx", "xxx", 'x', new ItemStack(ModBlocks.pearcel_matter_block), 'y', new ItemStack(ModItems.pearcel_matter));
