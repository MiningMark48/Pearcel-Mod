...
public class Recipes {
	...
	public static void init(){
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcelIngot), new ItemStack(ModItems.pearcel), new ItemStack(Items.iron_ingot));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pearcelCookie, 12), new ItemStack(Items.egg), new ItemStack(ModItems.pearcelFlour), new ItemStack(Items.sugar), new ItemStack(Items.milk_bucket));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.pearcelCookie, 4), " x ", "xyx", " x ", 'x', new ItemStack(ModItems.pearcel), 'y', new ItemStack(Items.cookie));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.pepc), "xyx", "aza", "yby", 'x', new ItemStack(ModItems.pearcelIngot), 'y', new ItemStack(ModItems.tier3Craft), 'z', new ItemStack(Blocks.ender_chest), 'a', new ItemStack(ModItems.pearcel), 'b', new ItemStack(ModItems.pearcelPearl));
        GameRegistry.addRecipe(new ItemStack(ModItems.experiencePearcel), "xyx", "aba", "xzx", 'x', new ItemStack(ModItems.pearcelIngot), 'y', new ItemStack(ModItems.tier3Craft), 'z', new ItemStack(Items.emerald), 'a', new ItemStack(Items.diamond), 'b', new ItemStack(ModItems.pearcel));
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.ivet), "cyc", "axa", "bzb", 'a', new ItemStack(Blocks.obsidian), 'b', new ItemStack(ModItems.tier3Craft), 'c', new ItemStack(Items.iron_ingot), 'x', new ItemStack(Blocks.crafting_table), 'y', new ItemStack(Items.book), 'z', new ItemStack(Items.diamond));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.torcher, 4), "xyx", "yzy", "xyx", 'x', new ItemStack(Items.gunpowder), 'y', new ItemStack(Blocks.torch), 'z', new ItemStack(ModItems.tier2Craft));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.torcher, 4), "xyx", "yzy", "xyx", 'y', new ItemStack(Items.gunpowder), 'x', new ItemStack(Blocks.torch), 'z', new ItemStack(ModItems.tier2Craft));
        ...
        GameRegistry.addRecipe(new ItemStack(Items.diamond, 16), "x  ", "x x", 'x', new ItemStack(ModItems.pearcelMatter));
