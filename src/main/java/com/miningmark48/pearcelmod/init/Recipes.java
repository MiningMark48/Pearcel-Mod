...
public class Recipes {
    ...
    public static void init(){
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.tier_1_crafting_component, 2), "xyx", "yzy", "xyx", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(Items.REDSTONE), 'z', new ItemStack(ModItems.pearcel_item));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.tier_3_crafting_component, 4), "xyx", "yzy", "xyx", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(Items.DIAMOND), 'z', new ItemStack(ModItems.tier_2_crafting_component));
        GameRegistry.addRecipe(new ItemStack(ModItems.tier_4_crafting_component, 6), "xyx", "yzy", "xyx", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(Items.NETHER_STAR), 'z', new ItemStack(ModItems.tier_3_crafting_component));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.pearcel_stone_placer), "xyx", "acb", "xzx", 'x', new ItemStack(ModItems.pearcel_item), 'y', new ItemStack(ModBlocks.pearcel_stone), 'z', new ItemStack(Blocks.COBBLESTONE), 'a', new ItemStack(Items.LAVA_BUCKET), 'b', new ItemStack(Items.WATER_BUCKET), 'c', new ItemStack(ModItems.tier_2_crafting_component));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.rif_pearcel_helmet), "xzx", "zyz", "xzx", 'x', new ItemStack(ModItems.tier_3_crafting_component), 'y', new ItemStack(ModItems.pearcel_helmet), 'z', new ItemStack(ModItems.armor_plating));
        GameRegistry.addRecipe(new ItemStack(ModItems.rif_pearcel_chestplate), "xzx", "zyz", "xzx", 'x', new ItemStack(ModItems.tier_3_crafting_component), 'y', new ItemStack(ModItems.pearcel_chestplate), 'z', new ItemStack(ModItems.armor_plating));
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.pearcel_backpack), "xxx", "zyz", "xxx", 'x', new ItemStack(ModItems.pearcel_item), 'y', new ItemStack(ModItems.tier_2_crafting_component), 'z', new ItemStack(Blocks.CHEST));
