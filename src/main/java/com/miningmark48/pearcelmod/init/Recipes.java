...
public class Recipes {
    ...
    public static void init(){
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_fence, 3), "xyx", "xyx", 'x', new ItemStack(ModBlocks.pearcel_planks), 'y', new ItemStack(ModItems.pearcel_stick));
