...
public class Recipes {
    ...
    public static void init(){
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.tier_3_crafting_component, 1), "xyx", "aza", "xax", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(Items.DIAMOND), 'z', new ItemStack(ModItems.pearcel_item), 'a', new ItemStack(ModItems.tier_2_crafting_component));
        GameRegistry.addRecipe(new ItemStack(ModItems.tier_2_crafting_component, 1), "xyx", "aza", "xax", 'x', new ItemStack(ModItems.pearcel_ingot), 'y', new ItemStack(Items.IRON_INGOT), 'z', new ItemStack(ModItems.pearcel_item), 'a', new ItemStack(ModItems.tier_1_crafting_component));
