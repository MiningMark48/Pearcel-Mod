...
public class Recipes {
    ...
    public static void init(){
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.pearcel_furnace), "xxx", "xyx", "xzx", 'x', new ItemStack(ModBlocks.pearcel_cobblestone), 'y', new ItemStack(ModItems.tier_2_crafting_component), 'z', new ItemStack(Blocks.FURNACE));
