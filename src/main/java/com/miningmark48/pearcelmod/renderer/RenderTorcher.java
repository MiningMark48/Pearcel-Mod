...
public class RenderTorcher extends TileEntitySpecialRenderer{

    private final ModelTorcher model;

    public RenderTorcher(){

        this.model = new ModelTorcher();
    }
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        ResourceLocation texture = new ResourceLocation(Reference.MOD_ID + ":textures/model/torcher.png");
