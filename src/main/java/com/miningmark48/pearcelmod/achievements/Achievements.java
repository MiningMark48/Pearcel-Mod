...
public class Achievements {
    ...
    public static void init(){
        ...
        AchievementPage.registerAchievementPage(new AchievementPage("Pearcel Mod", new Achievement[]{achievementPearcelSword, achievementSugarCookie, achievementPearcelOre, achievementPearcelMelon}));
